...
var display_or_not = [
    ...
    'div:settings', 'div:board','lst:games'
];
...
function setScenario(s) {
    ...
    if (lst) {
        ...
        if (['chats', 'contacts', 'connex', 'kanban','games'].indexOf(curr_scenario) >= 0) {
...
function btnBridge(e) {
    var e = e.id, m = '';
    if (['btn:chats', 'btn:posts', 'btn:contacts', 'btn:connex', 'btn:kanban', 'btn:games'].indexOf(e) >= 0) {
